...
export function Stepper(props: Partial<Props>) {
	...
	const handleValueChange = React.useCallback(
		...
		[validation, step, min, max, state.value, onValueChange]
	)

	const decrement = React.useCallback(() => handleValueChange(-1), [])
	const increment = React.useCallback(() => handleValueChange(1), [])
