export const imports = {
  ...
  'src/components/Link.mdx': () =>
    import(
      /* webpackPrefetch: true, webpackChunkName: "src-components-link" */ 'src/components/Link.mdx'
    ),
  'src/components/Radio.mdx': () =>
    import(
      /* webpackPrefetch: true, webpackChunkName: "src-components-radio" */ 'src/components/Radio.mdx'
    ),
  'src/components/RadioGroup.mdx': () =>
    import(
